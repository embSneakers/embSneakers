...
(a) Three bins (from left, high, mid, and low, respectively) for the color embedding.<br>
...
(a) Three bins (from left, high, mid, and low, respectively) for the shape embedding.<br>
